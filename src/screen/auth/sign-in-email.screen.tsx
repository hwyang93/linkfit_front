...
import { removeWhitespace, validateEmail } from '@/lib/util';
...
type Props = NativeStackScreenProps<AuthStackParamList, typeof ROUTE.AUTH.SIGN_IN_EMAIL>;

export const SignInEmailScreen = ({ navigation }: Props) => {
  ...
  const checkMember = async () => {
    ...
    try {
      ...
      if (response.data.seq) {
        navigation.navigate(ROUTE.AUTH.SIGN_IN_PASSWORD, { email: email.value });
      } else {

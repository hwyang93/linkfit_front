    ...
    <Pressable onPress={onPress}>
      <View
        ...
        <View
          ...
          {selected && (
            <Image
              style={[common.size24, { position: 'absolute', right: 16, top: '50%' }]}
...
export const JobPostScreen = ({ route }: Props) => {
          ...
          <SafeAreaView edges={['left', 'right', 'top']} style={styles.container}>
            <ScrollView
              ...
              {recruitInfo.recruitType === '대강' ? (
                <View style={common.mb24}>
                  <Text style={[common.mb8, common.text_m, common.fwb]}>수업날짜 및 시간</Text>
              ...
              {recruitInfo.writer?.type === MEMBER_TYPE.COMPANY && (
                <View>
          ...
          <BottomSheet
            ...
            <View style={{ width: '100%', paddingHorizontal: 16 }}>
              ...
              <View style={common.mt40}>
                <CTAButton
                  label="지원하기"
                  disabled={!selectedResumeSeq || selectedRecruitDates.length === 0}

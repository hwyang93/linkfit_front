...
type Props = NativeStackScreenProps<LoggedInParamList, typeof ROUTE.MY.SEND_SUGGESTION_DETAIL>;

export const SendSuggestionDetailScreen = ({}: Props) => {
  ...
  return (
    <SafeAreaView edges={['bottom', 'left', 'right']} style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        <View>
          <Text style={[common.title_l, common.mt16, common.mb16]}>필라테스 전임 강사 제안</Text>
          ...
          <Text style={[common.text_m, common.mb40]}>
            안녕하세요. 링크 필라테스 원장입니다. 저희가 찾고 있는 포지션에 적합한 인재라고 생각되어
            이렇게 제안드립니다. 긍정적인 검토 부탁드리며, 관련 자세한 내용이 궁금하시다면 응답기간
            내 회신 부탁드립니다.
          </Text>
          ...
          <View style={common.mb24}>
            <Text style={[common.text_m, common.fwb, common.mb8]}>강사 정보</Text>
            <View>
